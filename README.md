...
3. Run 🚀 Rocket 11
   1. Prerequisites
      ...
      ```
   2. Modify the installation medium
      ```bash
      git clone https://github.com/MaykGyver/rocket11.git; cd rocket11  # get and enter the 🚀 Rocket 11 experience
      pipenv install  # sets up the Python virtual environment for rocket11.py from Pipfile
      sudo pipenv run python rocket11.py  # runs 🚀 Rocket 11 in the virtual environment
      ```
...
When 🚀 Rocket 11 matured and multiple users reported succesful use, we will fork it and start 🚀 Rocket 12.
